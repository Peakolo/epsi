            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 align-items-center">Listes des rapports</h1>
                    </div>
                                        ...
                                        include'connexion2.php';
                                            ...
                                            '<div class="table-responsive">
                                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>';
                                        $reponse = $con->query('SELECT dateJ,num_rap, praticien, date, motif, bilan, medicament, avis_visiteur FROM form_visite');     //filtrer l’ordre des résultats inverse l'ordre grace a DESC
