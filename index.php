       ...
       <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                        ...
                        <div class="sidebar-brand-text mx-3">Epsi Lyon
                        </div>
                    </a>
                            ...
                            <div class="col-xl-15 col-lg-10">
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Vos compte rendu de Ticket</h6>
                                            ...
                                            while ($donnees = $reponse->fetch()){
                                                echo
                                                            '<tr>
                                                                ...
                                                                <td>' . htmlspecialchars($donnees['materiaux']) . '</td>
                                                               
                                                                <td>'. htmlspecialchars($donnees['motif']).'</td>
                                                                
                                                                <td>'.htmlspecialchars($donnees['urgent']).'</td>
